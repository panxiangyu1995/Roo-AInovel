...
export function getNovelFrameworkRefineDescription(): string {
	return t("tools:novelFrameworkRefine.description", {
		defaultValue: `Analyze and provide improvement options for novel framework using the Framework Service.
...
The service uses the ask_followup_question tool to present improvement options to the user and capture their selection.
